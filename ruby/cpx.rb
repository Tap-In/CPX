...
#
	def redisGet(label,key,wait)
		m = {"command" => "redis",  "subcommand" => "get",  "key" => key, "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
#
	def redisSet(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "set",  "key" => key, "value" => value,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
#
	def redisPub(label,chan,msg,wait)
		m = {"command" => "redis", "subcommand" => "pub",  "channel" => chan, "message" => msg,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
#
	def redisSet(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "incrby",  "key" => key, "value" => value,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis Del
#
	def redisDel(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "set",  "key" => key, "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis exists
#
	def redisExists(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "exists",  "key" => key, "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis expire
#
	def redisExpire(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "expire",  "key" => key, "value" => value,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis rpush
#
	def redisRpush(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "rpush",  "key" => key, "value" => value,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis lpush
#
	def redisLpush(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "lpush",  "key" => key, "value" => value,  "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis rpop
#
	def redisRpop(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "rpop",  "key" => key, "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
...
# Redis lpop
#
	def redisLpop(label,key,value,wait)
		m = {"command" => "redis", "subcommand" => "lpop",  "key" => key, "wait" => wait};
		if label != nil
			m.store(:label,label) 
		end
		@y = m
